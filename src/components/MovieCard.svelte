...
<a href="/movie/{movie.id}/{type}" class="overflow-hidden cursor-pointer rounded-xl relative group">
	<div
		...
		<div>
			...
			>
				...
				<div class="opacity-60 text-sm ">
					{new Date(type == 'tv' ? movie.first_air_date : movie.release_date).getFullYear()}
				</div>
